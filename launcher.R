...
for(sp in 0:9) {
  ...
  mtext("develop-1402", 3, line=-2.5, adj=0.95, col="blue", cex=0.75)
  plot(benl, initialYear=2000, species=sp, ylim=ylim)
  mtext("develop-1802 + csv", 3, line=-2.5, adj=0.95, col="blue", cex=0.75)
  plot(bennc, initialYear=2000, species=sp, ylim=ylim)
  mtext("develop-1802 + ncdf", 3, line=-2.5, adj=0.95, col="blue", cex=0.75)
  plot(bent, initialYear=2000, species=sp, ylim=ylim)
  mtext("develop-1802 + test", 3, line=-2.5, adj=0.95, col="blue", cex=0.75)
}
